...
**Comportamento esperado:** Segundo as regras da IBJJF, o gesto de punição é o árbitro **elevando o braço à altura do ombro com o punho fechado (mão fechada)**. O sistema deve detectar esse gesto específico, não o braço apontando para baixo.
