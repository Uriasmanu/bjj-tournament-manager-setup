...
formulario de adicionar atleta, use apenas o layout não remova as logicas atuais
    ...
    <script>
        tailwind.config = {
            theme: {
                extend: {
                    colors: {
                        c1: '#092b5a', // Azul Profundo (Headers)
                        c2: '#09738a', // Azul Petróleo (Bordas/Foco)
                        c3: '#fcfaf4', // Fundo Suave (Base)
                        c4: '#78a890', // Verde Salvia (Botões/Ações)
                        c5: '#9ed1b7', // Verde Claro (Destaque)
                    }
                }
            }
        }
...
<body class="bg-c3 min-h-screen flex items-center justify-center p-4">

    <div class="bg-white p-8 rounded-2xl shadow-xl w-full max-w-lg border-t-8 border-c1">
        
        <h1 class="text-3xl font-bold text-c1 mb-6 text-center">Novo Atleta</h1>
        
        <form id="atletaForm" class="space-y-4">
            <div>
                <label class="block text-sm font-semibold text-c1 mb-1">Nome *</label>
                <input type="text" required class="w-full p-3 border-2 border-c2/30 rounded-lg focus:ring-2 focus:ring-c2 focus:border-c2 outline-none transition">
            </div>

            <div>
                <label class="block text-sm font-semibold text-c1 mb-1">Equipe *</label>
                <input type="text" required class="w-full p-3 border-2 border-c2/30 rounded-lg focus:ring-2 focus:ring-c2 focus:border-c2 outline-none transition">
            </div>

            <div class="grid grid-cols-2 gap-4">
                <div>
                    <label class="block text-sm font-semibold text-c1 mb-1">Gênero *</label>
                    <select required class="w-full p-3 border-2 border-c2/30 rounded-lg focus:ring-2 focus:ring-c2 focus:border-c2 outline-none transition bg-white">
                ...
                <div>
                    <label class="block text-sm font-semibold text-c1 mb-1">Peso (kg) *</label>
                    <input type="number" step="0.1" required class="w-full p-3 border-2 border-c2/30 rounded-lg focus:ring-2 focus:ring-c2 focus:border-c2 outline-none transition">
                </div>
            </div>

            <div>
                <label class="block text-sm font-semibold text-c1 mb-1">Faixa *</label>
                <input type="text" required class="w-full p-3 border-2 border-c2/30 rounded-lg focus:ring-2 focus:ring-c2 focus:border-c2 outline-none transition">
            </div>

            <div>
                <label class="block text-sm font-semibold text-c1 mb-1">Categoria *</label>
                <input type="text" required class="w-full p-3 border-2 border-c2/30 rounded-lg focus:ring-2 focus:ring-c2 focus:border-c2 outline-none transition">
            </div>

            <div>
                <label class="block text-sm font-semibold text-c1 mb-1">Ano de Nascimento *</label>
                <input type="number" min="1900" max="2099" required class="w-full p-3 border-2 border-c2/30 rounded-lg focus:ring-2 focus:ring-c2 focus:border-c2 outline-none transition">
            </div>

            <button type="submit" class="w-full bg-c4 hover:bg-c1 text-white font-bold py-4 rounded-lg transition transform active:scale-95 mt-4 shadow-lg">
                Cadastrar Atleta
            </button>
        </form>

        <div id="successMessage" class="hidden mt-6 p-4 bg-c5/20 text-c1 rounded-lg text-center font-medium border border-c4">
